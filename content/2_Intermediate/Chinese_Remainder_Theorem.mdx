...
<Resources>
  <Resource
    ...
    url="https://web.evanchen.cc/handouts/CRT/CRT.pdf"
    starred
  >
    Short handout with the statement, proof, and olympiad problems.
  </Resource>
  <Resource
    source="AoPSWiki"
    title="Chinese Remainder Theorem"
  ...
  >
    Statement, proof, and the general construction of the solution.
  </Resource>
  <Resource
    source="AoPSWiki"
    title="Chinese Remainder Theorem (Introductory)"
    url="https://artofproblemsolving.com/wiki/index.php/Chinese_Remainder_Theorem/Introductory"
  >
    Gentler version with fully worked examples.
  </Resource>
  <Resource
    source="JS"
  ...
  >
    CRT chapter with problems that combine it with other tools.
  </Resource>
  <Resource
    source="WP"
    title="Chinese Remainder Theorem"
  ...
  >
    History, general ring-theoretic statement, and algorithms.
  </Resource>
  <Resource
    source="EC"
    title="OTIS Excerpts"
  ...
  >
    Olympiad training excerpts, including CRT-based constructions.
  </Resource>
</Resources>
