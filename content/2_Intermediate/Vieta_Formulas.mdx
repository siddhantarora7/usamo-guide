...
<Resources>
  <Resource
    ...
    starred
  >
    Handout with the general formulas and plenty of AIME practice.
  </Resource>
  <Resource
    source="OL"
    title="Mastering AMC 10/12 (Ch. 13)"
    url="https://www.omegalearn.org/books/Mastering_AMC_1012_Book.pdf"
  >
    Direct PDF &mdash; Chapter 13 covers polynomials and Vieta.
  </Resource>
  <Resource
    source="OL"
    title="Video: Vieta's Formulas for Polynomials"
    url="https://youtu.be/czk6OsfrbxQ"
  >
    Derivation plus worked contest examples.
  </Resource>
  <Resource
    source="OL"
    title="Video: Polynomial Roots"
    url="https://youtu.be/Dp-pw6NNKRo"
  >
    Relating roots and coefficients in AMC 10/12 problems.
  </Resource>
  <Resource
    source="AoPSWiki"
    title="Factoring"
  ...
  >
    Factoring identities that pair naturally with Vieta.
  </Resource>
  <Resource
    source="WP"
    title="Vieta's Formulas"
  ...
  >
    General statement for degree $n$, with a proof sketch.
  </Resource>
</Resources>
